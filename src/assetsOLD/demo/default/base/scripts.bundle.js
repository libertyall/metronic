...
var KTUtil = function () {
	...
	return {
		init: function (t) {
			...
			return function (t, e) {
				for (var i = document.querySelectorAll(e), o = t.parentNode; o && !n(i, o);) o = o.parentNode;
				return o;
			}(t, e);
			...
			var a = {};
			if (a.linear = function (t, e, n, i) {
				return n * t / i + e;
			}, o = a.linear, 'number' == typeof t && 'number' == typeof e && 'number' == typeof n && 'function' == typeof i) {
				...
				l(function a(d) {
					var c = (d || +new Date) - u;
					c >= 0 && i(o(c, t, s, n)), c >= 0 && c >= n ? (i(e), r()) : l(a);
				});
			}
			...
			if (!(!t || 'up' == e && !1 === KTUtil.visible(t) || 'down' == e && !0 === KTUtil.visible(t))) {
				n = n || 600;
				var r = KTUtil.actualHeight(t), a = !1, l = !1;
				KTUtil.css(t, 'padding-top') && !0 !== KTUtil.data(t).has('slide-padding-top') && KTUtil.data(t).set('slide-padding-top', KTUtil.css(t, 'padding-top')), KTUtil.css(t, 'padding-bottom') && !0 !== KTUtil.data(t).has('slide-padding-bottom') && KTUtil.data(t).set('slide-padding-bottom', KTUtil.css(t, 'padding-bottom')), KTUtil.data(t).has('slide-padding-top') && (a = parseInt(KTUtil.data(t).get('slide-padding-top'))), KTUtil.data(t).has('slide-padding-bottom') && (l = parseInt(KTUtil.data(t).get('slide-padding-bottom'))), 'up' == e ? (t.style.cssText = 'display: block; overflow: hidden;', a && KTUtil.animate(0, a, n, function (e) {
			...
			if (e) {
				...
				return KTUtilDelegatedEventHandlers[ o ] = function (n) {
					for (var o = t.querySelectorAll(e), r = n.target; r && r !== t;) {
						for (var a = 0, l = o.length; a < l; a++) r === o[ a ] && i.call(r, n);
						r = r.parentNode;
					}
			...
			r > a ? (i = r, o = a) : (i = a, o = r), e && (o += e), KTUtil.animate(i, o, n, function (t) {
...
var KTHeader = function (t, e) {
	...
	if (void 0 !== i) {
		var r = { classic: !1, offset: { mobile: 150, desktop: 200 }, minimize: { mobile: !1, desktop: !1 } }, a = {
	...
	if (o) {
		var a = {
			...
			construct: function (t) {
				...
				n.options = KTUtil.deepExtend({}, a, t), n.pauseDropdownHoverTime = 0, l.reset(), n.eventHandlers = {}, l.build(), KTUtil.data(o).set('menu', n);
			}, reload: function () {
				...
				if ('accordion' !== l.getSubmenuMode(this) && !1 !== n.resumeDropdownHover()) {
					'1' == this.getAttribute('data-hover') && (this.removeAttribute('data-hover'), clearTimeout(this.getAttribute('data-timeout')), this.removeAttribute('data-timeout')), l.showSubmenuDropdown(this);
				}
				...
				if ('accordion' !== l.getSubmenuMode(e)) {
					...
					if (n.length > 0 && !1 === KTUtil.hasClass(e, 'kt-menu__toggle') && 0 === e.querySelectorAll('.kt-menu__toggle').length) for (var i = 0, r = n.length; i < r; i++) l.hideSubmenuDropdown(n[ 0 ], !0);
				}
			}, handleSubmenuAccordion: function (t, e) {
				var i, o = e || this;
				if ('dropdown' === l.getSubmenuMode(e) && (i = o.closest('.kt-menu__item')) && 'accordion' != i.getAttribute('data-ktmenu-submenu-mode')) t.preventDefault(); else {
					var r = o.closest('.kt-menu__item'), a = KTUtil.child(r, '.kt-menu__submenu, .kt-menu__inner');
					if (!KTUtil.hasClass(o.closest('.kt-menu__item'), 'kt-menu__item--open-always') && r && a) {
						t.preventDefault();
							...
							if (!1 === n.options.accordion.expandAll) {
								...
								if (u && d) for (var c = 0, m = d.length; c < m; c++) {
									...
									g && KTUtil.slideUp(g, s, function () {
										l.scrollUpdate(), KTUtil.removeClass(f, 'kt-menu__item--open');
									});
								}
							}
							KTUtil.slideDown(a, s, function () {
								l.scrollToItem(o), l.scrollUpdate(), l.eventTrigger('submenuToggle', a);
							}), KTUtil.addClass(r, 'kt-menu__item--open');
						} else KTUtil.slideUp(a, s, function () {
							l.scrollToItem(o), l.eventTrigger('submenuToggle', a);
				...
				if (e) for (var n = 0, i = e.length; n < i; n++) {
					var a = e[ n ];
					t !== a && !1 === a.contains(t) && !1 === t.contains(a) && l.hideSubmenuDropdown(a, !0);
				}
				...
				for (var e, i, r = 0, a = (e = o.querySelectorAll('.kt-menu__item--active')).length; r < a; r++) {
					var l = e[ 0 ];
					KTUtil.removeClass(l, 'kt-menu__item--active'), KTUtil.hide(KTUtil.child(l, '.kt-menu__submenu'));
					for (var s = 0, u = (i = KTUtil.parents(l, '.kt-menu__item--submenu')).length; s < u; s++) {
						var d = i[ r ];
						KTUtil.removeClass(d, 'kt-menu__item--open'), KTUtil.hide(KTUtil.child(d, '.kt-menu__submenu'));
					}
				}
				if (!1 === n.options.accordion.expandAll && (e = o.querySelectorAll('.kt-menu__item--open'))) for (r = 0, a = e.length; r < a; r++) KTUtil.removeClass(i[ 0 ], 'kt-menu__item--open');
			}, setActiveItem: function (t) {
				l.resetActiveItem(), KTUtil.addClass(t, 'kt-menu__item--active');
				for (var e = KTUtil.parents(t, '.kt-menu__item--submenu'), n = 0, i = e.length; n < i; n++) KTUtil.addClass(e[ n ], 'kt-menu__item--open');
				...
				for (var o = KTUtil.parents(t, '.kt-menu__item--submenu'), r = 0, a = o.length; r < a; r++) {
					var l = KTUtil.child(o[ r ], '.kt-menu__link');
					n.push({
...
document.addEventListener('click', function (t) {
	...
	if (e = KTUtil.get('body').querySelectorAll('.kt-menu__nav .kt-menu__item.kt-menu__item--submenu.kt-menu__item--hover:not(.kt-menu__item--tabs)[data-ktmenu-submenu-toggle="click"]')) for (var n = 0, i = e.length; n < i; n++) {
		...
		if (o) {
			var r, a = KTUtil.data(o).get('menu');
			if (!a) break;
			if (!a || 'dropdown' !== a.getSubmenuMode()) break;
			if (t.target !== o && !1 === o.contains(t.target)) if (r = o.querySelectorAll('.kt-menu__item--submenu.kt-menu__item--hover:not(.kt-menu__item--tabs)[data-ktmenu-submenu-toggle="click"]')) for (var l = 0, s = r.length; l < s; l++) a.hideDropdown(r[ l ]);
		}
	}
});
var KTOffcanvas = function (t, e) {
	...
	if (i) {
		var r = {}, a = {
			construct: function (t) {
				...
				}); else if (n.options.toggleBy && n.options.toggleBy[ 0 ] && n.options.toggleBy[ 0 ].target) for (var t in n.options.toggleBy) KTUtil.addEvent(n.options.toggleBy[ t ].target, 'click', function (t) {
					t.preventDefault(), a.toggle();
				...
				'shown' != n.state && (a.eventTrigger('beforeShow'), a.togglerClass(t, 'show'), KTUtil.addClass(o, n.classShown), KTUtil.addClass(i, n.classShown), n.state = 'shown', n.options.overlay && (n.overlay = KTUtil.insertAfter(document.createElement('DIV'), i), KTUtil.addClass(n.overlay, n.classOverlay), KTUtil.addEvent(n.overlay, 'click', function (e) {
					e.stopPropagation(), e.preventDefault(), a.hide(t);
				})), a.eventTrigger('afterShow'));
			}, hide: function (t) {
				'hidden' != n.state && (a.eventTrigger('beforeHide'), a.togglerClass(t, 'hide'), KTUtil.removeClass(o, n.classShown), KTUtil.removeClass(i, n.classShown), n.state = 'hidden', n.options.overlay && n.overlay && KTUtil.remove(n.overlay), a.eventTrigger('afterHide'));
	...
	var n = this, i = KTUtil.get(t), o = KTUtil.get('body');
	if (i) {
		var r = { offset: 300, speed: 600, toggleClass: 'kt-scrolltop--on' }, a = {
			construct: function (t) {
